...
# Исполняемый файл "калькулятора" представляет из себя цикл, в котором реализованы запросы
# на входные данные с защитой от ошибок при некорректном введении этих данных.
# Также реализован выход из цикла в любой из 3-х стадий запросов:
